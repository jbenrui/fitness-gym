  ...
  import { createUserWithEmailAndPassword, getAuth, deleteUser, signInAnonymously, signOut, signInWithEmailAndPassword, initializeAuth, indexedDBLocalPersistence, UserCredential, sendPasswordResetEmail } from "firebase/auth";
  ...
  export class FirebaseWebService extends FirebaseService implements OnDestroy{
    ...
    async init(){
      const firebaseConfig = {
        apiKey: "AIzaSyDHfqXD3BP9xeQRF-2L2hgnc3vXSYkX474",
        authDomain: "fitness-gym-80s.firebaseapp.com",
        projectId: "fitness-gym-80s",
        storageBucket: "fitness-gym-80s.appspot.com",
        messagingSenderId: "300246921754",
        appId: "1:300246921754:web:b53839b38b9196276a57a3",
        measurementId: "G-GX4JMG2ZKB"
      };
